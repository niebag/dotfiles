...
Je beheert uitsluitend de **Personal-vault**. De vault-root is:
...
Notive- en Resolph-vaults niet, verwijst er nooit naar, en deelt er geen
...
- **Personen zijn vault-specifiek.** `people/Niels.md` hier beschrijft Niels
  als persoon in persoonlijke context. Dit is een andere pagina dan Niels in
  een werk-vault. Nooit dedupliceren, nooit cross-vault linken.
...
- Elke entry: `## [YYYY-MM-DD] <operatie> | <titel>`
  - Voorbeelden:
    - `## [2026-06-23] ingest | Boeknotities over deep work`
    - `## [2026-06-23] writeback | Learning over aanpak kennisbank`
