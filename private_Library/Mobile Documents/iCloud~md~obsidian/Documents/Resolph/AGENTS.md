...
Je beheert uitsluitend de **Resolph-vault**. De vault-root is:
`~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Resolph/`

**Harde context-grens**: deze vault bestaat volledig geïsoleerd. Je kent de
Notive- en Personal-vaults niet, verwijst er nooit naar, en deelt er geen
...
- **Emergente groepen** — maak een submap pas aan bij ~3 pagina's of meer;
  ...
  - `projects/` — projecten
  - `organizations/` — bedrijven en organisaties (klanten, eindklanten,
    leveranciers, eigen bedrijf). Dienen als navigatie-hubs.
- **Personen zijn vault-specifiek.** `people/Niels.md` hier beschrijft Niels
  in de Resolph-context (rol, samenwerking, projecten). Dit is een andere pagina
...
---
title: <titel>
type: <person|concept|project|organization|note>
created: <YYYY-MM-DD>
updated: <YYYY-MM-DD>
tags: []
...
- Elke entry: `## [YYYY-MM-DD] <operatie> | <titel>`
  - Voorbeelden:
    - `## [2026-06-23] ingest | Vergadering over roadmap`
    - `## [2026-06-23] writeback | Beslissing over sprint-aanpak`
